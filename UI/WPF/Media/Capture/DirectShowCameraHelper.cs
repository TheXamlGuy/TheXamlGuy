...
//public record MediaCaptureFrame2(byte[]? Buffer, int Width, int Height, int Stride);

//internal class DirectShowCameraHelper
//{
//    private Action<IntPtr, Size> SetPreviewControlMain;

//    public DirectShowCameraHelper(int cameraIndex, Size size) : this(cameraIndex, new VideoFormat() { Size = size })
//    {

//    }

//    public DirectShowCameraHelper(int cameraIndex, VideoFormat format)
//    {
//        string[] cameras = FindDevices();
...
//    public Func<MediaCaptureFrame2> GetBitmap { get; private set; }
...
//    {
//        return DirectShowCameraHelper.GetFiltes(DirectShowCameraHelper.DsGuid.CLSID_VideoInputDeviceCategory).ToArray();
//    }

//    public static VideoFormat[] GetVideoFormat(int cameraIndex)
//    {
//        DirectShowCameraHelper.IBaseFilter filter = DirectShowCameraHelper.CreateFilter(DirectShowCameraHelper.DsGuid.CLSID_VideoInputDeviceCategory, cameraIndex);
//        DirectShowCameraHelper.IPin pin = DirectShowCameraHelper.FindPin(filter, 0, DirectShowCameraHelper.PIN_DIRECTION.PINDIR_OUTPUT);
//        return GetVideoOutputFormat(pin);
//    }

//    public void SetPreviewSize(Size size)
//    {
//        SetPreviewControlMain(IntPtr.Zero, size);
//    }

//    private static MediaCaptureFrame2 BufferToBitmap(byte[] buffer, int width, int height, int stride)
//    {

//        return new MediaCaptureFrame2(buffer, width, height, stride);
//    }
...
//    private static VideoFormat[] GetVideoOutputFormat(DirectShowCameraHelper.IPin pin)
//    {
//        DirectShowCameraHelper.IAMStreamConfig? config = pin as DirectShowCameraHelper.IAMStreamConfig;
//        if (config == null)
//        {
...
//        if (cap_size != Marshal.SizeOf(typeof(DirectShowCameraHelper.VIDEO_STREAM_CONFIG_CAPS)))
//        {
...
//            DirectShowCameraHelper.AM_MEDIA_TYPE? mt = null;
//            config.GetStreamCaps(i, ref mt!, cap_data);
//            entry.Caps = PtrToStructure<DirectShowCameraHelper.VIDEO_STREAM_CONFIG_CAPS>(cap_data);

//            entry.MajorType = DirectShowCameraHelper.DsGuid.GetNickname(mt.MajorType);
//            entry.SubType = DirectShowCameraHelper.DsGuid.GetNickname(mt.SubType);

//            if (mt.FormatType == DirectShowCameraHelper.DsGuid.FORMAT_VideoInfo)
//            {
//                var vinfo = PtrToStructure<DirectShowCameraHelper.VIDEOINFOHEADER>(mt.pbFormat);
//                entry.Size = new Size(vinfo.bmiHeader.biWidth, vinfo.bmiHeader.biHeight);
//                entry.TimePerFrame = vinfo.AvgTimePerFrame;
//            }
//            else if (mt.FormatType == DirectShowCameraHelper.DsGuid.FORMAT_VideoInfo2)
//            {
//                var vinfo = PtrToStructure<DirectShowCameraHelper.VIDEOINFOHEADER2>(mt.pbFormat);
//                entry.Size = new Size(vinfo.bmiHeader.biWidth, vinfo.bmiHeader.biHeight);
//                entry.TimePerFrame = vinfo.AvgTimePerFrame;
//            }

//            DirectShowCameraHelper.DeleteMediaType(ref mt);
//            result[i] = entry;
//        }
...
//    private static void SetVideoOutputFormat(DirectShowCameraHelper.IPin pin, VideoFormat format)
//    {
...
//            if (item.MajorType != DirectShowCameraHelper.DsGuid.GetNickname(DirectShowCameraHelper.DsGuid.MEDIATYPE_Video))
//            {
//                continue;
//            }

//            if (string.IsNullOrEmpty(format.SubType) == false && format.SubType != item.SubType) continue;
//            if (item.Caps.Guid != DirectShowCameraHelper.DsGuid.FORMAT_VideoInfo) continue;
...
//        {
//            VideoFormat item = formats[i];
//            if (item.MajorType == DirectShowCameraHelper.DsGuid.GetNickname(DirectShowCameraHelper.DsGuid.MEDIATYPE_Video) && (string.IsNullOrEmpty(format.SubType) != false || format.SubType == item.SubType) && item.Caps.Guid == DirectShowCameraHelper.DsGuid.FORMAT_VideoInfo && item.Caps.OutputGranularityX != 0 && item.Caps.OutputGranularityY != 0)
//            {
...
//    private static void SetVideoOutputFormat(DirectShowCameraHelper.IPin pin, int index, Size size, long timePerFrame)
//    {
//        // IAMStreamConfigインタフェース取得
//        var config = pin as DirectShowCameraHelper.IAMStreamConfig;
//        if (config == null)
//        {
//            throw new InvalidOperationException("no IAMStreamConfig interface.");
//        }
...
//        var cap = PtrToStructure<DirectShowCameraHelper.VIDEO_STREAM_CONFIG_CAPS>(cap_data);
...
//        if (mt != null) DirectShowCameraHelper.DeleteMediaType(ref mt);
//    }

//    private DirectShowCameraHelper.IBaseFilter CreateSampleGrabber()
//    {
//        IBaseFilter filter = DirectShowCameraHelper.CreateFilter(DirectShowCameraHelper.DsGuid.CLSID_SampleGrabber);
//        var ismp = filter as DirectShowCameraHelper.ISampleGrabber;

//        var mt = new DirectShowCameraHelper.AM_MEDIA_TYPE();
//        mt.MajorType = DirectShowCameraHelper.DsGuid.MEDIATYPE_Video;
//        mt.SubType = DirectShowCameraHelper.DsGuid.MEDIASUBTYPE_RGB24;
//        ismp.SetMediaType(mt);
//        return filter;
//    }

//    private DirectShowCameraHelper.IBaseFilter CreateVideoCaptureSource(int index, VideoFormat format)
//    {
//        var filter = DirectShowCameraHelper.CreateFilter(DirectShowCameraHelper.DsGuid.CLSID_VideoInputDeviceCategory, index);
//        var pin = DirectShowCameraHelper.FindPin(filter, 0, DirectShowCameraHelper.PIN_DIRECTION.PINDIR_OUTPUT);
//        SetVideoOutputFormat(pin, format);
//        return filter;
//    }

//    private MediaCaptureFrame2 GetBitmapFromSampleGrabberBuffer(DirectShowCameraHelper.ISampleGrabber i_grabber, int width, int height, int stride)
//    {
//        try
//        {
...
//    private MediaCaptureFrame2 GetBitmapFromSampleGrabberBufferMain(DirectShowCameraHelper.ISampleGrabber i_grabber, int width, int height, int stride)
//    {
...
//    private Func<MediaCaptureFrame2>

//    GetBitmapFromSampleGrabberCallback(DirectShowCameraHelper.ISampleGrabber i_grabber, int width, int height, int stride)
//    {
...
//        var graph = DirectShowCameraHelper.CreateGraph();
...
//        var i_grabber = (DirectShowCameraHelper.ISampleGrabber)grabber;
//        i_grabber.SetBufferSamples(true); //サンプルグラバでのサンプリングを開始

//        //---------------------------------------------------
//        // Null Renderer
//        //---------------------------------------------------
//        var renderer = DirectShowCameraHelper.CoCreateInstance(DirectShowCameraHelper.DsGuid.CLSID_NullRenderer) as DirectShowCameraHelper.IBaseFilter;
//        graph.AddFilter(renderer, "NullRenderer");

//        //---------------------------------------------------
//        // Create Filter Graph
//        //---------------------------------------------------
//        var builder = DirectShowCameraHelper.CoCreateInstance(DirectShowCameraHelper.DsGuid.CLSID_CaptureGraphBuilder2) as DirectShowCameraHelper.ICaptureGraphBuilder2;
//        builder.SetFiltergraph(graph);
//        var pinCategory = DirectShowCameraHelper.DsGuid.PIN_CATEGORY_CAPTURE;
//        var mediaType = DirectShowCameraHelper.DsGuid.MEDIATYPE_Video;
...
//            var header = (DirectShowCameraHelper.VIDEOINFOHEADER)Marshal.PtrToStructure(mt.pbFormat, typeof(DirectShowCameraHelper.VIDEOINFOHEADER));
...
//        // Assign Delegates.
//        Start = () => DirectShowCameraHelper.PlayGraph(graph, DirectShowCameraHelper.FILTER_STATE.Running);
//        Stop = () => DirectShowCameraHelper.PlayGraph(graph, DirectShowCameraHelper.FILTER_STATE.Stopped);
//    }

//    public class PropertyItems
//    {
//        /// <summary>Camera Control properties.</summary>
//        private Dictionary<DirectShowCameraHelper.CameraControlProperty, Property> CameraControl;

//        /// <summary>Video Processing Amplifier properties.</summary>
//        private Dictionary<DirectShowCameraHelper.VideoProcAmpProperty, Property> VideoProcAmp;

//        public PropertyItems(DirectShowCameraHelper.IBaseFilter vcap_source)
//        {
//            // Pan, Tilt, Roll, Zoom, Exposure, Iris, Focus
//            CameraControl = Enum.GetValues(typeof(DirectShowCameraHelper.CameraControlProperty)).Cast<DirectShowCameraHelper.CameraControlProperty>()
//                .Select(item =>
//                {
//                    Property prop = null;
//                    try
//                    {
//                        var cam_ctrl = vcap_source as DirectShowCameraHelper.IAMCameraControl;
...
//                        Action<DirectShowCameraHelper.CameraControlFlags, int> set = (flag, value) => cam_ctrl.Set(item, value, (int)flag);
...
//            VideoProcAmp = Enum.GetValues(typeof(DirectShowCameraHelper.VideoProcAmpProperty)).Cast<DirectShowCameraHelper.VideoProcAmpProperty>()
//                .Select(item =>
//                {
//                    Property prop = null;
//                    try
//                    {
//                        var vid_ctrl = vcap_source as DirectShowCameraHelper.IAMVideoProcAmp;
...
//                        Action<DirectShowCameraHelper.CameraControlFlags, int> set = (flag, value) => vid_ctrl.Set(item, value, (int)flag);
...
//                }).ToDictionary(x => x.Key, x => x.Value);
//        }
//        public Property this[DirectShowCameraHelper.CameraControlProperty item] { get { return CameraControl[item]; } }

//        public Property this[DirectShowCameraHelper.VideoProcAmpProperty item] { get { return VideoProcAmp[item]; } }
...
//            public Property(int min, int max, int step, int @default, int flags, Action<DirectShowCameraHelper.CameraControlFlags, int> set, Func<int> get)
//            {
//                Min = min;
//                Max = max;
//                Step = step;
//                Default = @default;
//                Flags = (DirectShowCameraHelper.CameraControlFlags)flags;
//                CanAuto = (Flags & DirectShowCameraHelper.CameraControlFlags.Auto) == DirectShowCameraHelper.CameraControlFlags.Auto;
//                SetValue = set;
//                GetValue = get;
//                Available = true;
//            }
...
//            public DirectShowCameraHelper.CameraControlFlags Flags { get; private set; }
//            public Func<int> GetValue { get; private set; }
//            public int Max { get; private set; }
//            public int Min { get; private set; }
//            public Action<DirectShowCameraHelper.CameraControlFlags, int> SetValue { get; private set; }
...
//    {
//        public DirectShowCameraHelper.VIDEO_STREAM_CONFIG_CAPS Caps { get; set; }
...
//            sb.AppendFormat("{0}, ", DirectShowCameraHelper.DsGuid.GetNickname(Caps.Guid));
...
//    private class SampleGrabberCallback : DirectShowCameraHelper.ISampleGrabberCB
//    {
//        private byte[] Buffer;
...
//        public MediaCaptureFrame2  GetBitmap(int width, int height, int stride)
//        {
...
//        public int SampleCB(double SampleTime, DirectShowCameraHelper.IMediaSample pSample)
//        {
